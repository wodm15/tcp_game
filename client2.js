...
let userId;
let gameId = '4fa30f99-75ae-49ef-b5f4-3686eff60cac'; //이 부분 알맞게 수정
...
const createPacket = (handlerId, payload, version = '1.0.0', type, name) => {
...
client.connect(PORT, HOST, async () => {
  ...
  const successPacket = createPacket(0, { deviceId , playerId, latency}, '1.0.0', 'initial', 'InitialPacket');
